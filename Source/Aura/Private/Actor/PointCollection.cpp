...
TArray<FVector> APointCollection::GetGroundPoints(const FVector& GroundLocation, int32 NumPoints, float YawOverride) {
	...
	for (USceneComponent* Pt : ImmutablePts) {
		...
		TArray<AActor*> IgnoreActors = UAuraAbilitySystemLibrary::GetLivePlayersWithinRadius(this, TArray<AActor*>(), 1500.f, GetActorLocation());
		...
		Result.Add(Pt->GetComponentLocation());
	}
	return Result;
}
